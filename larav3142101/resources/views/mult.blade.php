            ...
            <div class="card-body p-4 p-md-5">
                <div class="row g-4">
                    <div class="col-md-6 d-flex align-items-center">
                        <div>
                            <h2 class="mb-1">Calculadora De Multiplicación</h2>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <form action="/multsubmit" method="POST" class="needs-validation" novalidate>
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary btn-lg">Multiplicar</button>
                            </div>
                        </form>
                    </div>
                </div>
